...
class NewPoll extends Component {
    ...
    addChoice(event) {
        ...
        this.setState({
            choices: choices.concat([{
                text: 'Players Username or Email'
            }])
        });
    }
    ...
    handleSubmit(event) {
        ...
        .then(response => {
            ...
            if(error.status === 401) {
                this.props.handleLogout('/login', 'error', 'You have been logged out. Please login to view your campaign.');    
            } else {
                notification.error({
                    message: 'Campaign Creating',
                    ...
                    <Form onSubmit={this.handleSubmit} className="create-poll-form">
                        ...
                        <FormItem className="poll-form-row">
                            <Button type="primary" 
                                ...
                                className="create-poll-form-button">Create Campaign</Button>
                        </FormItem>
                    </Form>
                </div>    
            </div>
...
function PollChoice(props) {
    return (
        ...
        help={props.choice.errorMsg} className="poll-form-row">
            <Input 
                placeholder = {'Username or Email of Player ' + (props.choiceNumber + 1)}
                size="large"
